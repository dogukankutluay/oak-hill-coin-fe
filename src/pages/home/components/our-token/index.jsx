    ...
    <div className={style.token} id="our-token" ref={reference}>
      ...
      <LeaveSvg
        className={cn(
          ...
          'animate__animated animate__slideInRight delay-100'
        )}
      />
      <div className={style.token_wrapper}>
        <h1
          className={cn(
            style.title,
            'animate__animated animate__fadeInDown delay-150'
          )}
        >
          Our Token
        </h1>
        ...
        <section className={style.token_infos}>
          <h1 className="animate__animated animate__fadeIn delay-400">
            100M <span>Tokens</span>{' '}
          </h1>
          <h1 className="animate__animated animate__fadeIn delay-450">
            100M <span>Shares</span>{' '}
          </h1>
          <h1 className="animate__animated animate__fadeIn delay-500">
            100M <span>NFTs</span>{' '}
          </h1>
        </section>
        <p
          className={cn(
            ...
            'animate__animated animate__fadeInUp delay-600'
          )}
        >
